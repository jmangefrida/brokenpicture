        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">Broken Picture</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <ul class="navbar-text navbar-right">
                <li class="dropdown">
                    <?php echo $greeting ?>  
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="start.php">Settings</a></li>
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Broken Picture</h1>
              <p>A fun game to play with friends.</p>
              <p><a class="btn btn-lg btn-primary" href="start.php" role="button">Play Now!</a></p>
              
            </div>
          </div>
        </div>
        <div class="item">
          <img src="img/mermaid.png" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
