...
<?php require_once 'ui/navbar.php';?>
    ...
    <div id="content" class="container">
      ...
      <div class="starter-template">
        ...
        <button id= "btn" type="button" class="btn btn-primary center-block" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Draw reply</button>
    </div><!-- /.container -->
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputEmail" placeholder="Jane.Doe@example.com">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger"  onclick="testing('end');" data-dismiss="modal">End Game</button>
      </div>
    </div>
  </div>
</div>
