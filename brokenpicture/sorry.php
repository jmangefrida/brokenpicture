...
<?php require_once 'ui/navbar.php';?>
    ...
    <div id="content" class="container">
      ...
      <div class="starter-template">
        <h1>Sorry, but this turn has already been taken.</h1>
        
      </div>
        <button id= "btn" type="button" class="btn btn-primary center-block disabled"  data-whatever="@mdo">Draw reply</button>
    </div><!-- /.container -->
